...
void SHT20_reset(void)
{
	...
	I2C_WriteByte(SHT20_ADDRESS, SHT20_SOFT_RESET, nullptr);
}
...
void SHT20_GetValue(void)
{
	...
	sht20_info.tempreture = SHT2x_MeasureHM(SHT20_Measurement_T_HM, nullptr);
	DelayXms(75);

	sht20_info.humidity = SHT2x_MeasureHM(SHT20_Measurement_RH_HM, nullptr);
	DelayXms(30);
